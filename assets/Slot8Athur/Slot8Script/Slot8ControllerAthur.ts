import cmd from './Slot8CmdAthur';

import Configs from "../../Loading/src/Configs";
import Slot4TrialResult from './Slot8TrialResultAthur';

import Slot8Lobby from "./Slot8.LobbyAthur";
import Slot8PopupBonus from "./Slot8.PopupBonusAthur";
import Slot8Tutorial from "./Slot8.TutorialAthur";
...
import Slot8ChooseLine from './Slot8ChooseLineAthur';
import Slot8ItemSlot from './Slot8.ItemSlotAthur';
import BundleControl from '../../Loading/src/BundleControl';
import Slot8History from './Slot8HistoryAthur';
import Slot8Glory from './Slot8GloryAthur';
...
@ccclass
export default class Slot8ControllerAthur extends cc.Component {
    @property(cc.Button)
    ...
    actGuide() {
        ...
        if (this.popupGuide == null) {
            BundleControl.loadPrefabGame("Slot8Athur", "thanbai/prefabs/PopupGuide", (finish, total) => {
    ...
    actHistory() {
        ...
        if (this.popupHistory == null) {
            BundleControl.loadPrefabGame("Slot8Athur", "thanbai/prefabs/History", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupHistory = cc.instantiate(prefab).getComponent("Slot8HistoryAthur");
    ...
    actHistoryJackpot() {
        ...
        if (this.popupHonor == null) {
            BundleControl.loadPrefabGame("Slot8Athur", "thanbai/prefabs/Glory", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupHonor = cc.instantiate(prefab).getComponent("Slot8GloryAthur");
    ...
    actChooseLine() {
        ...
        if (this.popupChooseLine == null) {
            BundleControl.loadPrefabGame("Slot8Athur", "thanbai/prefabs/ChooseLine", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupChooseLine = cc.instantiate(prefab).getComponent("Slot8ChooseLineAthur");
    ...
    actShowBonus(isTrial, dataHaiSao, cb) {
        ...
        if (this.popupBonus == null) {
            BundleControl.loadPrefabGame("Slot8Athur", "thanbai/prefabs/PopupBonus", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupBonus = cc.instantiate(prefab).getComponent("Slot8.PopupBonusAthur");
