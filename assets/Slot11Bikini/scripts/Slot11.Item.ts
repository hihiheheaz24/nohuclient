...
export default class Slot11ItemSlot extends cc.Component {
    ...
    dataAnimScatter: sp.SkeletonData = null;
    @property(sp.SkeletonData)
    dataAnimJackpot: sp.SkeletonData = null;
    @property(sp.SkeletonData)
    dataAnimBonus: sp.SkeletonData = null;
    @property(sp.SkeletonData)
    dataAnimWild: sp.SkeletonData = null;
    ...
    changeSpriteBlurByItemId(itemId) {
        ...
        this.spriteIcon.node.setContentSize(cc.size(this.spriteIcon.node.width, this.spriteIcon.node.height));
    }
        ...
        if (itemId > 3) {
            ...
            switch (itemId) {
                case 0:
                    ...
                    this.spineIcon.skeletonData = this.dataAnimScatter;
                    break;
                case 1:
                    this.animName = "bonus";
                    this.spineIcon.skeletonData = this.dataAnimBonus;
                    break;
                case 2:
                    this.animName = "wild";
                    this.spineIcon.skeletonData = this.dataAnimWild;
                    break;
                case 3:
                    this.animName = "jackpot";
                    this.spineIcon.skeletonData = this.dataAnimJackpot;
                    break;
            }
