...
export default class Slot11Lobby extends cc.Component {
    ...
    public onUpdateJackpot(pData) {
        ...
        Tween.numberTo(this.listPot[0], resJson['bikini']['100'].p, 3.0);
        Tween.numberTo(this.listPot[1], resJson['bikini']['1000'].p, 3.0);
        Tween.numberTo(this.listPot[2], resJson['bikini']['10000'].p, 3.0);
    }
}
