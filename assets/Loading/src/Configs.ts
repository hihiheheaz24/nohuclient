...
namespace Configs {
    export class Login {
        ...
        static PhoneNumner: string = "";
        static SAFE: number = 0;
        static LevelReceived: number = 0;
        static LevelCurrent: number = 0;
        ...
        static readonly VipPoints = [20, 30, 60, 120, 200, 600, 1000, 1600, 2400, 4000, 8000, 12000, 16000, 20000];
        static readonly VipPointsName = ["VIP1", "VIP2", "VIP3", "VIP4", "VIP5", "VIP6", "VIP7", "VIP8", "VIP9", "VIP10", "VIP11", "VIP12", "VIP13", "VIP14", "VIP15"];
        static readonly VipPointsMoney = [20000, 36000, 90000, 216000, 400000, 1100000, 2500000, 4480000, 7680000, 14000000, 32000000, 55200000, 83200000, 120000000];
        static readonly VipPointsNameRutGon = ["V1", "V2", "V3", "V4", "V5", "V6", "V7", "V8", "V9", "V10", "V11", "V12", "V13", "V14", "V15"];
        static TopDayVipPointsMoney = [5000000, 3000000, 1000000, 500000, 300000, 200000, 100000];
        static TopDayVipPointsMoneyEvent = [120000000, 40000000, 20000000, 15000000, 10000000];
        static getVipPointName(): string {
            for (let i = this.VipPoints.length - 1; i >= 0; i--) {
                if (Configs.Login.VipPointSave > this.VipPoints[i]) {
        ...
        static getVipChat(): string {
            for (let i = this.VipPoints.length - 1; i >= 0; i--) {
                if (Configs.Login.VipPointSave > this.VipPoints[i]) {
                    return this.VipPointsNameRutGon[i + 1];
                }
            }
            return this.VipPointsNameRutGon[0];
        }
    ...
    export class App {
        // 43.128.27.35
        public static IS_LOCAL = !CC_JSB;
        public static IS_PRO = true;
        static API: string = "https://iportal.mt09l3t2.shop/api";
		static API2: string = "https://iportal.mt09l3t2.shop/api";
		static APIROY: string = "https://portal.mt09l3t2.shop/api";
        ...
        static LINK_GROUP = "https://www.facebook.com/groups/1567419770073574";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/MKTNOHU";
            }
        }
