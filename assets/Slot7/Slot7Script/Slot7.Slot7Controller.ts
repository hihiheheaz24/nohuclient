        ...
        for (let i = 0; i < this.reels.childrenCount; i++) {
            ...
            roll.runAction(cc.sequence(
                ...
                cc.callFunc(() => {
                    ...
                    listItemNode[1].getComponent(Slot7Item).setId(parseInt(matrix[5 + i]));
                    listItemNode[0].getComponent(Slot7Item).setId(parseInt(matrix[10 + i]));
                    listItemNode[listItemNode.length - 1].getComponent(Slot7Item).setId(parseInt(matrix[i]));
                    listItemNode[listItemNode.length - 2].getComponent(Slot7Item).setId(parseInt(matrix[5 + i]));
                    listItemNode[listItemNode.length - 3].getComponent(Slot7Item).setId(parseInt(matrix[10 + i]));
                })
            ));
        }
    }
