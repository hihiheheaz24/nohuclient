...
import Slot1Controller from "./Slot1.Slot1FrozenController";

const { ccclass, property } = cc._decorator;

@ccclass
export default class Slot1FrozenLobby extends cc.Component {
    ...
    public onUpdateJackpot(pData) {
        ...
        if (this.listPot[0].string == "0") {
            this.listPot[0].string = (resJson['frozen']['100'] - 100000) + "";
            this.listPot[1].string = (resJson['frozen']['1000'] - 1000000) + "";
            this.listPot[2].string = (resJson['frozen']['10000'] - 10000000) + "";
        }
        Tween.numberTo(this.listPot[0], resJson['frozen']['100'].p, 4);
        Tween.numberTo(this.listPot[1], resJson['frozen']['1000'].p, 4);
        Tween.numberTo(this.listPot[2], resJson['frozen']['10000'].p, 4);
    }
}
