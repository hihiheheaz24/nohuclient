...
@ccclass
export default class Slot1ItemSlotFrozen extends cc.Component {
    ...
    init(itemId, index, gamePlayManager) {
        ...
        this.spriteIcon.node.setContentSize(cc.size(this.spriteIcon.node.width / 0.9, this.spriteIcon.node.height / 1));
