...
import cmd from './Slot1.CmdFrozen';
import Slot1ItemSlot from './Slot1.ItemSlotFrozen';
import Slot1Lobby from "./Slot1.LobbyFrozen";
import Slot1PopupBonus from './Slot1.PopupBonusFrozen';
import PopupHistory from './Slot1.PopupHistoryFrozen';
import PopupJackpotHistory from './Slot1.PopupJackpotHistoryFrozen';
import PopupSelectLine from './Slot1.PopupSelectLineFrozen';
import Slot1TrialResult from './Slot1.TrialResultsFrozen';
...
@ccclass
export default class Slot1FrozenController extends cc.Component {
    @property(cc.Node)
    ...
    actHistoryJackpot() {
        ...
        if (this.popupJackpotHistory == null) {
            BundleControl.loadPrefabGame("Slot1Frozen", "duaxe/prefabs/PopupJackpotHistory", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupJackpotHistory = cc.instantiate(prefab).getComponent("Slot1.PopupJackpotHistoryFrozen");
    ...
    actHistory() {
        ...
        if (this.popupHistory == null) {
            BundleControl.loadPrefabGame("Slot1Frozen", "duaxe/prefabs/PopupHistory", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupHistory = cc.instantiate(prefab).getComponent("Slot1.PopupHistoryFrozen");
    ...
    actGuide() {
        ...
        if (this.popupGuide == null) {
            BundleControl.loadPrefabGame("Slot1Frozen", "duaxe/prefabs/PopupGuide", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupGuide = cc.instantiate(prefab).getComponent("Slot1.PopupGuideFrozen");
    ...
    actSelectLine() {
        ...
        if (this.popupSelectLine == null) {
            BundleControl.loadPrefabGame("Slot1Frozen", "duaxe/prefabs/PopupSelectLine", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupSelectLine = cc.instantiate(prefab).getComponent("Slot1.PopupSelectLineFrozen");
    ...
    actShowBonus(isTrial, dataHaiSao, cb) {
        ...
        if (this.popupBonus == null) {
            BundleControl.loadPrefabGame("Slot1Frozen", "duaxe/prefabs/PopupBonus", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupBonus = cc.instantiate(prefab).getComponent("Slot1.PopupBonusFrozen");
