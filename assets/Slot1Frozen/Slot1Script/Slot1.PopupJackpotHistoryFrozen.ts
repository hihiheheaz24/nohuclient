...
@ccclass
export class PopupJackpotHistoryFrozen extends Dialog {
    @property(cc.Label)
    ...
    private loadData() {
        ...
        Http.get(Configs.App.API, { "c": 138, "p": this.page, "gn": "FROZEN" }, (err, res) => {
...
export default PopupJackpotHistoryFrozen;