...
export namespace cmd {
    export class Code {
        static SUBCRIBE = 21003;
        static UNSUBCRIBE = 21004;
        static CHANGE_ROOM = 21005;
        static PLAY = 21001;
        static UPDATE_RESULT = 21001;
        static UPDATE_POT = 21002;
        static AUTO = 21006;
        static STOP_AUTO = 21006;
        static FORCE_STOP_AUTO = 21008;
        static DATE_X2 = 21009;
        static BIG_WIN = 21010;
        static FREE = 21011;
        static FREE_DAI_LY = 21012;
        static MINIMIZE = 21013;
