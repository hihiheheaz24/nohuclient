...
export default class UIItemDiemDanh extends cc.Component {
    ...
    getDescription(gameId) {
        ...
        switch (gameId) {
            ...
            //     break;
            case 170:
                des = "Tổng cược Ice 200k Tặng 1 lượt quay Tarzan 100";
                break;
            case 110:
                des = "Tổng cược Tarzan 200k Tặng 1 lượt quay Sinbad 100";
                break;
            case 160:
                des = "Tổng cược Sinbad 200k Tặng 1 lượt quay Hallowen 100";
                break;
            case 150:
                des = "Tổng cược Hallowen 200k Tặng 1 lượt quay Ice 100";
                break;
            case 180:
                des = "Tổng cược Zeus 200k Tặng 1 lượt quay Sinbad 100";
                break;
        }
        return des;
    }
    ...
    onBtnLam() {
        ...
        if (Global.LobbyController.popupDiemDanh !== null && Global.LobbyController.popupDiemDanh !== undefined) {
            Global.LobbyController.popupDiemDanh.dismiss();
        }
    }
