...
export default class App extends cc.Component {
    ...
    static API_AG: string = "https://ga.mt09l3t2.shop/3rd/ag";
    static API_EBET: string = "https://ga.mt09l3t2.shop/3rd/ebet";
        ...
        SlotNetworkClient.getInstance().addListener((data) => {
            ...
            switch (inPacket.getCmdId()) {
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT3X3: {
                    ...
                    this.showJackpotNotify(res, "Siêu Xe");
                    break;
                }
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT3x3GEM: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, "Candy");
                    break;
                }
                ...
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT1: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, "Tazan");
                    break;
                }
                ...
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT4: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, "Sinbad");
                    break;
                }
                // case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT5: {
                //     let res = new cmd.ResNotifyJackpot(data);
                //     this.showJackpotNotify(res, "Chiêm Tinh");
                //     break;
                // }
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT7: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, "ICE");
                    break;
                }
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT8: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, "ZEUS");
                    break;
                }
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT5: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, " Vampire");
                    break;
                }
                case cmd.Code.UPDATE_BIGWIN_JACKPOT_SLOT11: {
                    let res = new cmd.ResNotifyJackpot(data);
                    this.showJackpotNotify(res, "Kim Cương");
                    break;
                }
            }
        }, this);
    ...
    showLoading(isShow: boolean, timeOut: number = 15) {
        this.loading.zIndex = cc.macro.MAX_ZINDEX + 1;
