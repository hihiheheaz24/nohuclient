...
export namespace cmd {
    export class Code {
        ...
        static readonly VALIDATE_OTP_PHONE = 20013;

        static readonly VIPPOINT_RECEIVED_MONEY = 20400;
        static readonly EVENT_LOGOUT = 20077;
    ...
    export class ResGetSecurityInfo extends InPacket {
        ...
        constructor(data: Uint8Array) {
            ...
            this.teleId = this.getString();
            this.vippoint = this.getLong();
            this.vippointSave = this.getLong();
        }
    }
    ...
    export class ReqTransferCoin extends OutPacket {
        constructor(nickname: string, coin: number, note: string, otp: String) {
            super();
            this.initData(100);
            this.setControllerId(1);
    ...
    export class ReqSafes extends OutPacket {
        constructor(coin: number, action: number, otp: string) {
            super();
            this.initData(100);
            this.setControllerId(1);
    ...
    export class ReqValidateOtp extends OutPacket {
        constructor(mobile: string, otp: string) {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.VALIDATE_OTP_PHONE);
            this.packHeader();
            this.putString(mobile);
            this.putString(otp);
            this.updateSize();
    ...
    export class ResValidateOtp extends InPacket {
        error = 0;
    ...
    export class ReqVippointReceived extends OutPacket {
        constructor(level: number) {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.VIPPOINT_RECEIVED_MONEY);
            this.packHeader();
            this.putInt(level);
            this.updateSize();
        }
    ...
    export class ResVippointReceived extends InPacket {
        error = 0;
        message = "";
        money = 0;
