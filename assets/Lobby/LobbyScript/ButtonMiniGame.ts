...
export default class ButtonMiniGame extends cc.Component {
    ...
    actButtonIBC() {
        if (Configs.Login.CACHE_IBC) {
            ...
            App.instance.cacheWebView["IBC"].position = cc.v3(0, 0, 0);
        }
        else {
    ...
    actButtonAG() {
        ...
        ////Utils.Log("actButtonAG:" + App.instance.cacheWebView["AG"]);
            App.instance.cacheWebView["AG"].position = cc.v3(0, 0, 0);
        }
        else {
    ...
    actButtonWM() {
        if (Configs.Login.CACHE_WM) {
            SPUtils.setMusicVolumn(0);
            BroadcastReceiver.send(BroadcastReceiver.ON_AUDIO_CHANGED);
            App.instance.cacheWebView["WM"].position = cc.v3(0, 0, 0);
        }
        else {
    ...
    hidden() {
        ...
        this.panel.active = false;
        this.button.active = false;
        this.button.x = cc.winSize.width / 2 - 90;
    }
