...
var ListGame = ["Tài khoản chính", "Live Casino AG", "Live Casino EBET", "Live Casino WM", "Vampire IBC2", "Vampire SBO", "Bắn Cá"];
var _this = null;
@ccclass
export default class GameLiveController extends cc.Component {
    ...
    onLoad() {
        _this = this;
        ListGame = [App.instance.getTextLang("txt_main_account"), "Live Casino AG", "Live Casino EBET", "Live Casino WM", "Vampire IBC2", "Vampire SBO", "Bắn Cá"];
    }
    show() {
