...
namespace Lobby {
    ...
    @ccclass
    export class PopupLoginLobby extends cc.Component {
        ...
        atcPopupForgotPass() {
            var sefl = this;
            let cb = (prefab) => {
                let popupDaily = cc.instantiate(prefab).getComponent("Lobby.PopupForgetPassword");
                App.instance.node.addChild(popupDaily.node)
                App.instance.popupForgetPassword = popupDaily;
                App.instance.popupForgetPassword.show2(sefl.edbUsername.string);
            }
        ...
        public actLogin() {
            ...
            Global.LobbyController.actLogin(username, password, () => {
                ...
                if (sefl.toggleRemember.isChecked === false) {
                    sefl.edbUsername.string = "";
                    sefl.edbPassword.string = "";
                }
            });
