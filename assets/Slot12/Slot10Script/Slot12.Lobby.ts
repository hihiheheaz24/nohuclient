...
import Slot10Controller from "./Slot12.Slot10Controller";

const { ccclass, property } = cc._decorator;

@ccclass
export default class Slot12Lobby extends cc.Component {
    ...
    public onUpdateJackpot(pData) {
        ...
        Tween.numberTo(this.listPot[0], resJson['thanden']['100'].p, 0.3);
        Tween.numberTo(this.listPot[1], resJson['thanden']['1000'].p, 0.3);
        Tween.numberTo(this.listPot[2], resJson['thanden']['10000'].p, 0.3);
    }
}
